<template>
  <div>
    <div class="d-flex justify-space-between align-center mb-6">
      <h1 class="text-h4">Договоры</h1>
      <v-btn color="primary" to="/contract/create">
...
const deleteItem = async () => {
  ...
  try {
    await api.delete(`/api/contracts/${itemToDelete.value.id}`)
