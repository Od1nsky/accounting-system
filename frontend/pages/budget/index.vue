<template>
  <div>
    <div class="d-flex justify-space-between align-center mb-6">
      <h1 class="text-h4">Бюджеты</h1>
      <v-btn color="primary" to="/budget/create">
...
const headers = [
  ...
  { title: 'Тип', key: 'type' },
  { title: 'PlannedAmount', key: 'plannedAmount' },
  { title: 'ActualAmount', key: 'actualAmount' },
...
const deleteItem = async () => {
  ...
  try {
    await api.delete(`/api/budgets/${itemToDelete.value.id}`)
