<template>
  <div>
    <div class="d-flex justify-space-between align-center mb-6">
      <h1 class="text-h4">Спринты</h1>
      <v-btn color="primary" to="/sprint/create">
...
const headers = [
  ...
  { title: 'Скорость', key: 'velocity' },
  { title: 'Ёмкость', key: 'capacity' },
...
const deleteItem = async () => {
  ...
  try {
    await api.delete(`/api/sprints/${itemToDelete.value.id}`)
