<template>
  <div>
    <div class="d-flex justify-space-between align-center mb-6">
      <h1 class="text-h4">Счета</h1>
      <v-btn color="primary" to="/account/create">
...
const headers = [
  ...
  { title: 'Тип', key: 'type' },
  { title: 'Родительский код', key: 'parentCode' },
...
const deleteItem = async () => {
  ...
  try {
    await api.delete(`/api/accounts/${itemToDelete.value.id}`)
