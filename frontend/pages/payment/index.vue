<template>
  <div>
    <div class="d-flex justify-space-between align-center mb-6">
      ...
      <v-btn color="primary" to="/payment/create">
...
const headers = [
  ...
  { title: 'Счёт', key: 'invoiceId' },
  { title: 'Контрагент', key: 'counterpartyId' },
  { title: 'Дата', key: 'date' },
  { title: 'Тип', key: 'type' },
  { title: 'Способ', key: 'method' },
...
const deleteItem = async () => {
  ...
  try {
    await api.delete(`/api/payments/${itemToDelete.value.id}`)
